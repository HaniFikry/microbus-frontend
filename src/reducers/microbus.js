...
import {REGISTER_NEW_USER_LOADING, REGISTER_NEW_USER_SUCCESS, REGISTER_NEW_USER_FAILURE, USER_LOGIN_LOADING, USER_LOGIN_SUCCESS, USER_LOGIN_FAILURE, USER_LOGOUT, FETCH_USER_SUCCESS, FETCH_WISHLIST_LOADING, FETCH_WISHLIST_SUCCESS, FETCH_WISHLIST_FAILURE, ADD_ITEM_TO_WISHLIST_LOADING, ADD_ITEM_TO_WISHLIST_SUCCESS, ADD_ITEM_TO_WISHLIST_FAILURE, CREATE_WISHLIST_ITEM_LOADING, CREATE_WISHLIST_ITEM_SUCCESS, CREATE_WISHLIST_ITEM_FAILURE, DELETE_WISHLIST_ITEM_LOADING, DELETE_WISHLIST_ITEM_SUCCESS, DELETE_WISHLIST_ITEM_FAILURE, SAVE_CURRENT_LOCATION, UPDATE_USER_BALANCE_SUCCESS, CLEAR_CONSUMER_MESSAGES} from '../actions/consumer'
...
export default function(currentState = INITIAL_STATE, action) {
  switch (action.type) {
    ...
    case REGISTER_NEW_USER_SUCCESS:
        return {
          ...currentState,
          message: "User registered successfully, you will be redirected shortly",
          loading: false
        }
